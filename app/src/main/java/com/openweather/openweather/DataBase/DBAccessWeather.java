...
public class DBAccessWeather extends SQLiteOpenHelper {
    ...
    public long add(){
        ...
        va701.put("code_id",1);
        va701.put("description","tropical storm");
        ...
        va702.put("code_id",2);
        va702.put("description","hurricane");
        ...
        va703.put("code_id",3);
        va703.put("description","severe thunderstorms");
        ...
        va704.put("code_id",4);
        va704.put("description","thunderstorms");
        ...
        va705.put("code_id",5);
        va705.put("description","mixed rain and snow");
        ...
        va706.put("code_id",6);
        va706.put("description","mixed rain and sleet");
        ...
        va707.put("code_id",7);
        va707.put("description","mixed snow and sleet");
        ...
        va708.put("code_id",8);
        va708.put("description","freezing drizzle");
        ...
        va710.put("description","freezing rain");
        ...
        va712.put("description","showers");
        va712.put("Wearing_Suggest","11");
        db.insert("Code", null, va712);

        //Code13
        ContentValues va713 = new ContentValues();
        va713.put("code_id",13);
        va713.put("description","snow flurries");
        ...
        va714.put("description","light snow showers");
        ...
        va715.put("description","blowing snow");
        ...
        va723.put("description","blustery");
        ...
        va727.put("description","mostly cloudy (night)");
        ...
        va728.put("description","mostly cloudy (day)");
        ...
        va729.put("description","partly cloudy (night)");
        ...
        va730.put("description","partly cloudy (day)");
        ...
        va731.put("description","clear (night)");
        ...
        va733.put("description","fair (night)");
        ...
        va734.put("description","fair (day)");
        ...
        va735.put("description","mixed rain and hail");
        ...
        va737.put("description","isolated thunderstorms");
        ...
        va738.put("description","scattered thunderstorms");
        ...
        va739.put("description","scattered thunderstorms");
        ...
        va740.put("description","scattered showers");
        ...
        va741.put("description","heavy snow");
        ...
        va742.put("description","scattered snow showers");
        ...
        va743.put("description","heavy snow");
        ...
        va744.put("description","partly cloudy");
        ...
        va745.put("description","thundershowers");
        ...
        va746.put("description","snow showers");
        ...
        va747.put("description","isolated thundershowers");
        ...
        va748.put("description","not available");
