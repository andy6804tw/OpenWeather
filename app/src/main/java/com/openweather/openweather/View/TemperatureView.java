...
public class TemperatureView extends View {
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = mTypedArray.getColor(R.styleable.TemperatureView_backgroundColor, Color.WHITE);
        mThermometerColor = mTypedArray.getColor(R.styleable.TemperatureView_thermometerColor, Color.RED);
        mValueColor = mTypedArray.getColor(R.styleable.TemperatureView_valueColor, Color.WHITE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mProgress != 0f) {
            ...
            canvas.drawLine(mWidth / 2, mMin * 8.5f, mWidth/ 2, mMin * (7.5f - 7 * mProgress / 98), mPaints[0]);
        }
